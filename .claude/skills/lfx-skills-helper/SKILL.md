...
description: >
  ...
  checks or repair, hand off to /lfx-skills-doctor.
...
Same as `/lfx-skills-doctor`. Try in order:
...
| **Diagnose** a problem / "why isn't X working" | Hand off to `/lfx-skills-doctor` | Stop here.                  |
...
- **Diagnostic questions** ("is my install OK?", "why isn't /lfx-foo working?", "fix my broken symlinks"): hand off to `/lfx-skills-doctor`.
...
- **Diagnose problems**: hand off to `/lfx-skills-doctor`.
