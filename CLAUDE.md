...
You are inside the LFX Skills source repository. Four meta-skills are auto-discovered here (via committed `.claude/skills/` symlinks) so you can help users without anything else being installed first:
