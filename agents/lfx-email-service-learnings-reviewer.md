---
name: lfx-email-service-learnings-reviewer
...
This agent is packaged centrally and may be launched from the LFX workspace root or a multi-repo session. Regardless of the current working directory, it always reviews `lfx-v2-email-service`.
