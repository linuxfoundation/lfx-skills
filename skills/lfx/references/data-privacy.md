...
| UUID / IDs | `uuid.NewString()` or a fixed valid UUID such as `00000000-0000-4000-8000-000000000001` (RFC 4122 v4 / variant 10; strict UUID validators reject the `-0000-0000-` form because the version and variant nibbles are zero) | Copy-pasted production UUIDs from a real record |
